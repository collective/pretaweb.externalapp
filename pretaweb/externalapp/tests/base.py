...
def setup_product():
    ...
    import pretaweb.externalapp
    zcml.load_config('configure.zcml', pretaweb.externalapp)
    ...
    ztc.installPackage('pretaweb.externalapp')
...
setup_product()
ptc.setupPloneSite(products=['pretaweb.externalapp'])
